...
### 1.) Using the statistical properties of the variance as well as single variable calculus, derive 5.6. In other words, prove that $\alpha$ given by 5.6 does indeed minimize $Var(\alphaX + (1 - \alpha)Y$
